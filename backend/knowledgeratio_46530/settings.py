"""
Django settings for knowledgeratio_46530 project.
...
ROOT_URLCONF = 'knowledgeratio_46530.urls'
...
WSGI_APPLICATION = 'knowledgeratio_46530.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "knowledgeratio_46530 API",
    "DESCRIPTION": "API documentation for knowledgeratio_46530 App",
    "VERSION": "v1",
}
